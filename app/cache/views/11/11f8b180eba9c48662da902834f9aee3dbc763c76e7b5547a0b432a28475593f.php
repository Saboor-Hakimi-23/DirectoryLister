...
class __TwigTemplate_fa5edf92b78c0f92b6d5c665f562d3f761aa799a6fa4ace3f51d26574c4359fa extends Template
{
    private $source;
    private $macros = [];
...
>
    <div class=\"container flex justify-end mx-auto px-4 py-10 xl:max-w-screen-xl\">
        <button title=\"";
        // line 5
        echo twig_escape_filter($this->env, $this->env->getFunction('translate')->getCallable()("scroll_to_top"), "html", null, true);
...
";
    ...
    {
        return new Source("", "components/scroll-to-top.twig", "/var/www/html/app/views/components/scroll-to-top.twig");
    }
}
