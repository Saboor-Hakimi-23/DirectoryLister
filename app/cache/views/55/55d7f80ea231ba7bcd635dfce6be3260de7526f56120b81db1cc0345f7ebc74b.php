...
/* index.twig */
class __TwigTemplate_2102866ab8908a0604adc2239ada9f772890296f96beb1d67f2ef49e214a3ca6 extends Template
{
    private $source;
    private $macros = [];
        ...
        <div class=\"my-4\">
            <div class=\"flex justify-between font-bold p-4\">
                <div class=\"flex-grow font-mono mr-2\">
                    ";
        // line 10
        echo twig_escape_filter($this->env, $this->env->getFunction('translate')->getCallable()("file.name"), "html", null, true);
        echo "
                </div>
                ...
                <div class=\"font-mono text-right w-1/6 mx-2 hidden sm:block\">
                    ";
        // line 14
        echo twig_escape_filter($this->env, $this->env->getFunction('translate')->getCallable()("file.size"), "html", null, true);
        echo "
                </div>
                ...
                <div class=\"font-mono text-right w-1/4 ml-2 hidden sm:block\">
                    ";
        // line 18
        echo twig_escape_filter($this->env, $this->env->getFunction('translate')->getCallable()("file.date"), "html", null, true);
        echo "
                </div>
            </div>
    ...
    {
        return new Source("", "index.twig", "/var/www/html/app/views/index.twig");
    }
}
