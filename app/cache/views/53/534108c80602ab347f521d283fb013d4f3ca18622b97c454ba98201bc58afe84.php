...
class __TwigTemplate_5b0a8dbe8a9e3a09998c191438bf97b419065fa9237504f58721f5c006c7260b extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"border-t border-blue-500 dark:border-purple-600\">
        ...
        echo "
            ";
        // line 24
        if (((($context["path"] ?? null) &&  !twig_test_empty(($context["files"] ?? null))) && $this->env->getFunction('config')->getCallable()("zip_downloads"))) {
            // line 25
            echo "                <a href=\"";
            echo twig_escape_filter($this->env, $this->env->getFunction('zip_url')->getCallable()(($context["path"] ?? null)), "html", null, true);
            echo "\" title=\"";
            echo twig_escape_filter($this->env, $this->env->getFunction('translate')->getCallable()("download"), "html", null, true);
            echo "\" rel=\"nofollow\"
...
";
    ...
    {
        return new Source("", "components/header.twig", "/var/www/html/app/views/components/header.twig");
    }
}
