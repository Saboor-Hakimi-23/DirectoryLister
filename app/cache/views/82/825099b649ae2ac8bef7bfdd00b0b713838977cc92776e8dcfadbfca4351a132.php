...
class __TwigTemplate_3fa35bb3d774de561fc68455d9c85387b1c29aa54c3a47cb802c7c3ad2ab2f01 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo (($this->env->getFunction('config')->getCallable()("readmes_first")) ? ("order-first") : (null));
    ...
    <div class=\"rounded-lg overflow-hidden shadow-md\">
        ...
        if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["readme"] ?? null), "getExtension", [], "any", false, false, false, 8), "md"))) {
            // line 9
            echo "                ";
            echo $this->env->getFunction('markdown')->getCallable()(twig_get_attribute($this->env, $this->source, ($context["readme"] ?? null), "getContents", [], "any", false, false, false, 9));
            echo "
            ";
        } else {
            // line 11
...
";
    ...
    {
        return new Source("", "components/readme.twig", "/var/www/html/app/views/components/readme.twig");
    }
}
